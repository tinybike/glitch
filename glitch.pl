...
use warnings;
use strict;
my $HOME = 'E:/lter/fsdbdata/data/';
use lib 'E:/lter/fsdbdata/data/';
use CGI;
use DBI;
use Time::JulianDay;
use Math::Trig;
...
stcode,format,sitecode,probe,date_time,$P{v1},$P{f1}$more
EOF
;
}
...
"SELECT e.entity_file_name,
	...
	e.entity_number,
	e.entity_id
FROM ltermeta..entity e, ltermeta..sub_entity se
